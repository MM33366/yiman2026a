...
<head>
    ...
    <script>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Chen,Yi-Man";
		}
	</script>
...
<body>
    ...
    <table width="70%" border="1">
		<tr>
			<td>
    threads:<a href="https://www.threads.com/@yiman_0330"target="_blank">https://www.threads.com/@yiman_0330</a><br>
    E-Mail:<a href="mailto:emma65454@gmail.com">emma65454@gmail.com</a><br>
   </td>
